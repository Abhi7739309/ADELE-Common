...
import org.ow2.chameleon.runner.test.probe.Activator;
...
public class ProbeBundleMaker {
    ...
    public static final String PACKAGES_TO_ADD = "org.ow2.chameleon.runner.test.parents.*, " +
            "org.ow2.chameleon.runner.test.probe";
    ...
    public static InputStream probe() throws Exception {
        ...
        System.out.println("**********Temp BND file; " + bnd.getAbsolutePath());
        //builder.getJar().putResource("/.", new FileResource(new File("src/test/resources")));
